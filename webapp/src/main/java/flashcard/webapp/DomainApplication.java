 ...
 *      &lt;param-value>flashcard.webapp.DomainApplication&lt;/param-value>
 *    &lt;/init-param>
 * &lt;/filter>
 * </pre>
 * 
...
public class DomainApplication extends IsisWicketApplication {
    ...
    protected void init() {
        ...
        settings.setThemeProvider(new BootswatchThemeProvider(BootswatchTheme.Cosmo));
    }

    private static final String APP_NAME = "Flashcards";
